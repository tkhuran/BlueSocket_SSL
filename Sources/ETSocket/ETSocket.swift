...
public class ETSocketError: ErrorProtocol, CustomStringConvertible {
...
public class ETSocket: ETReader, ETWriter {
    ...
    ///
    var readBuffer: UnsafeMutablePointer<CChar> = UnsafeMutablePointer<CChar>(allocatingCapacity: ETSocket.SOCKET_DEFAULT_READ_BUFFER_SIZE)
    ...
    public class func dottedIP(fromAddress: in_addr) ->String? {
        ...
        return String(validatingUTF8: inet_ntoa(fromAddress))
    }
    ...
    deinit {
        ...
        self.readBuffer.deinitialize(count: 0)
    ...
    public func createSSLContext(usingCertificate cert: String?, andKey key: String?) throws {
        ...
        let certFile: String = cert ?? ETSocket.DEFAULT_SSL_CERTIFICATE
        ...
        let keyFile: String = key ?? ETSocket.DEFAULT_SSL_PRIVATE_KEY
